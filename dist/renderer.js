...
// ../harborclient-sdk/dist/components/Button/index.js
var VARIANT_CLASSES = {
...
// ../harborclient-sdk/dist/components/FieldError/index.js
...
// ../harborclient-sdk/node_modules/.pnpm/@fortawesome+fontawesome-svg-core@7.3.0/node_modules/@fortawesome/fontawesome-svg-core/index.mjs
...
function _createClass(e4, r4, t3) {
  return r4 && _defineProperties(e4.prototype, r4), t3 && _defineProperties(e4, t3), Object.defineProperty(e4, "prototype", {
    writable: false
  }), e4;
}
function _createForOfIteratorHelper(r4, e4) {
  var t3 = "undefined" != typeof Symbol && r4[Symbol.iterator] || r4["@@iterator"];
  if (!t3) {
    if (Array.isArray(r4) || (t3 = _unsupportedIterableToArray(r4)) || e4 && r4 && "number" == typeof r4.length) {
      t3 && (r4 = t3);
...
function _objectSpread2(e4) {
  for (var r4 = 1; r4 < arguments.length; r4++) {
    ...
    r4 % 2 ? ownKeys(Object(t3), true).forEach(function(r5) {
      _defineProperty(e4, r5, t3[r5]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e4, Object.getOwnPropertyDescriptors(t3)) : ownKeys(Object(t3)).forEach(function(r5) {
      Object.defineProperty(e4, r5, Object.getOwnPropertyDescriptor(t3, r5));
    });
  }
  return e4;
}
...
// ../harborclient-sdk/node_modules/.pnpm/@fortawesome+react-fontawesome@3.3.1_@fortawesome+fontawesome-svg-core@7.3.0_react@19.2.7/node_modules/@fortawesome/react-fontawesome/dist/index.js
...
// ../harborclient-sdk/dist/components/FaIcon/index.js
...
// ../harborclient-sdk/node_modules/.pnpm/@fortawesome+free-solid-svg-icons@7.3.0/node_modules/@fortawesome/free-solid-svg-icons/index.mjs
var faXmark = {
  prefix: "fas",
  iconName: "xmark",
...
// ../harborclient-sdk/node_modules/.pnpm/@faker-js+faker@10.5.0/node_modules/@faker-js/faker/dist/base-DzmKJ9Qc.js
...
function s2(e4) {
  ...
  for (let n3 of e4) for (let e5 in n3) {
    let r4 = n3[e5];
    t3[e5] === void 0 ? t3[e5] = { ...r4 } : t3[e5] = { ...r4, ...t3[e5] };
  }
  return t3;
}
var c2 = 2567483615;
...
function h2(e4) {
  let t3 = m2(19650218), n3 = 1, r4 = 0;
  for (let i3 = Math.max(624, e4.length); i3 !== 0; --i3) {
    let i4 = t3[n3 - 1] ^ t3[n3 - 1] >>> 30;
    t3[n3] = f2((t3[n3] ^ d2(i4, 1664525)) + e4[r4] + r4), n3++, r4++, n3 >= 624 && (t3[0] = t3[623], n3 = 1), r4 >= e4.length && (r4 = 0);
  }
...
function te(e4 = {}) {
  let { locale: t3 = {}, randomizer: n3 = y2(), config: r4 = {}, seed: a3 } = e4;
  return n3 != null && a3 != null && n3.seed(a3), { locale: i2(Array.isArray(t3) ? s2(t3) : t3), randomizer: n3, config: r4 };
}
function b2() {
  return ne;
}
...
var ce = class extends S2 {
  ...
  recordLocator(e4 = {}) {
    let { allowNumerics: t3 = false, allowVisuallySimilarCharacters: n3 = false } = e4, r4 = [];
    return t3 || r4.push(...ie), n3 || r4.push(...ae), this.faker.string.alphanumeric({ length: 6, casing: `upper`, exclude: r4 });
  }
  seat(e4 = {}) {
    let { aircraftType: t3 = `narrowbody` } = e4, n3 = oe[t3], r4 = se[t3];
  ...
  flightNumber(e4 = {}) {
    let { length: t3 = { min: 1, max: 4 }, addLeadingZeros: n3 = false } = e4, r4 = this.faker.string.numeric({ length: t3, allowLeadingZeros: false });
...
function O2(e4, t3, n3 = `rgb`, r4 = `sRGB`) {
  switch (t3) {
    case `css`:
      return fe(e4, n3, r4);
    case `binary`:
...
var pe = class extends S2 {
  ...
  rgb(e4 = {}) {
    let { format: t3 = `hex`, includeAlpha: n3 = false, prefix: r4 = `#`, casing: i3 = `lower` } = e4, a3, o3 = `rgb`;
    return t3 === `hex` ? (a3 = this.faker.string.hexadecimal({ length: n3 ? 8 : 6, prefix: `` }), a3 = de(a3, { prefix: r4, casing: i3 }), a3) : (a3 = Array.from({ length: 3 }, () => this.faker.number.int(255)), n3 && (a3.push(this.faker.number.float({ multipleOf: 0.01 })), o3 = `rgba`), O2(a3, t3, o3));
  }
  cmyk(e4 = {}) {
  ...
  hsl(e4 = {}) {
    let { format: t3 = `decimal`, includeAlpha: n3 = false } = e4, r4 = [this.faker.number.int(360)];
    for (let t4 = 0; t4 < (e4?.includeAlpha ? 3 : 2); t4++) r4.push(this.faker.number.float({ multipleOf: 0.01 }));
    return O2(r4, t3, n3 ? `hsla` : `hsl`);
  }
  hwb(e4 = {}) {
...
function me(t3) {
  ...
  let n3 = 0, r4 = 0;
  for (let e4 of t3) n3 += Number.parseInt(e4, 10) * (r4 % 2 == 0 ? 3 : 1), r4++;
  return (10 - n3 % 10) % 10;
}
...
var ge = class extends S2 {
  ...
  price(e4 = {}) {
    let { dec: t3 = 2, max: n3 = 1e3, min: r4 = 1, symbol: i3 = `` } = e4;
    if (r4 < 0 || n3 < 0) return `${i3}0`;
    if (r4 === n3) return `${i3}${r4.toFixed(t3)}`;
    let a3 = this.faker.number.float({ min: r4, max: n3, fractionDigits: t3 });
    ...
    return r4 <= d3 && d3 <= n3 ? `${i3}${d3.toFixed(t3)}` : `${i3}${a3.toFixed(t3)}`;
  }
  productAdjective() {
  ...
  isbn(t3 = {}) {
    ...
    let { variant: n3 = 13, separator: r4 = `-` } = t3, [i3, a3] = this.faker.helpers.objectEntry(he), o3 = this.faker.string.numeric(8), s3 = Number.parseInt(o3.slice(0, -1)), c3 = a3.find(([e4]) => s3 <= e4)?.[1];
...
function k2(t3, n3 = `refDate`) {
  let r4 = new Date(t3);
  if (Number.isNaN(r4.valueOf())) throw new e2(`Invalid ${n3} date: ${t3.toString()}`);
  return r4;
}
var A2 = class extends x2 {
  ...
  past(t3 = {}) {
    let { refDate: n3 = this.faker.defaultRefDate() } = t3, { years: r4 = 1 } = t3;
  ...
  between(t3) {
    let { from: n3, to: r4 } = t3, i3 = k2(n3, `from`).getTime(), a3 = k2(r4, `to`).getTime();
    if (i3 > a3) throw new e2("`from` date must be before `to` date.");
    return new Date(this.faker.number.int({ min: i3, max: a3 }));
  }
  betweens(e4) {
    let { from: t3, to: n3, count: r4 = 3 } = e4;
    return this.faker.helpers.multiple(() => this.between({ from: t3, to: n3 }), { count: r4 }).toSorted((e5, t4) => e5.getTime() - t4.getTime());
  }
  recent(t3 = {}) {
    let { refDate: n3 = this.faker.defaultRefDate() } = t3, { days: r4 = 1 } = t3;
  ...
  birthdate(t3 = {}) {
    let { mode: n3 = `age`, min: r4 = 18, max: i3 = 80, refDate: a3 = this.faker.defaultRefDate() } = t3, o3 = k2(a3), s3 = o3.getUTCFullYear();
    switch (n3) {
      case `age`: {
        let t4 = new Date(o3).setUTCFullYear(s3 - i3 - 1) + 1440 * 60 * 1e3, n4 = new Date(o3).setUTCFullYear(s3 - r4);
        if (t4 > n4) throw new e2(`Max age ${i3} should be greater than or equal to min age ${r4}.`);
        return this.between({ from: t4, to: n4 });
      }
      case `year`: {
        let t4 = new Date(Date.UTC(0, 0, 2)).setUTCFullYear(r4), n4 = new Date(Date.UTC(0, 11, 30)).setUTCFullYear(i3);
        if (t4 > n4) throw new e2(`Max year ${i3} should be greater than or equal to min year ${r4}.`);
        return this.between({ from: t4, to: n4 });
      }
    }
  }
...
var ye = class extends A2 {
  ...
  month(e4 = {}) {
    let { abbreviated: t3 = false, context: n3 = false } = e4, r4 = this.faker.definitions.date.month, i3;
    i3 = t3 ? n3 && r4.abbr_context != null ? `abbr_context` : `abbr` : n3 && r4.wide_context != null ? `wide_context` : `wide`;
    let o3 = r4[i3];
    return a2(o3, `date.month`, i3), this.faker.helpers.arrayElement(o3);
  }
  weekday(e4 = {}) {
    let { abbreviated: t3 = false, context: n3 = false } = e4, r4 = this.faker.definitions.date.weekday, i3;
    i3 = t3 ? n3 && r4.abbr_context != null ? `abbr_context` : `abbr` : n3 && r4.wide_context != null ? `wide_context` : `wide`;
    let o3 = r4[i3];
...
var Ce = class extends S2 {
  ...
  amount(e4 = {}) {
    let { autoFormat: t3 = false, dec: n3 = 2, max: r4 = 1e3, min: i3 = 0, symbol: a3 = `` } = e4, o3 = this.faker.number.float({ max: r4, min: i3, fractionDigits: n3 });
  ...
  bitcoinAddress(e4 = {}) {
    let { type: t3 = this.faker.helpers.enumValue(j2), network: n3 = `mainnet` } = e4, r4 = xe[t3], i3 = r4.prefix[n3], a3 = this.faker.number.int(r4.length);
  ...
  creditCardNumber(e4 = {}) {
    ...
    let { issuer: t3 = `` } = e4, n3, r4 = this.faker.definitions.finance.credit_card, i3 = t3.toLowerCase();
  ...
  iban(t3 = {}) {
    let { countryCode: n3, formatted: r4 = false } = t3, i3 = n3 ? M2.formats.find((e4) => e4.country === n3) : this.faker.helpers.arrayElement(M2.formats);
...
var Te = class extends S2 {
  ...
  commitEntry(e4 = {}) {
    let { merge: t3 = this.faker.datatype.boolean({ probability: 0.2 }), eol: n3 = `CRLF`, refDate: r4 } = e4, i3 = [`commit ${this.faker.git.commitSha()}`];
...
`;
  ...
  commitDate(e4 = {}) {
    let { refDate: t3 = this.faker.defaultRefDate() } = e4, n3 = [`Sun`, `Mon`, `Tue`, `Wed`, `Thu`, `Fri`, `Sat`], r4 = [`Jan`, `Feb`, `Mar`, `Apr`, `May`, `Jun`, `Jul`, `Aug`, `Sep`, `Oct`, `Nov`, `Dec`], i3 = this.faker.date.recent({ days: 1, refDate: t3 }), a3 = n3[i3.getUTCDay()], o3 = r4[i3.getUTCMonth()], s3 = i3.getUTCDate(), c3 = i3.getUTCHours().toString().padStart(2, `0`), l3 = i3.getUTCMinutes().toString().padStart(2, `0`), u3 = i3.getUTCSeconds().toString().padStart(2, `0`), d3 = i3.getUTCFullYear(), f3 = this.faker.number.int({ min: -11, max: 12 }), p3 = Math.abs(f3).toString().padStart(2, `0`);
...
var De = /\.|\(/;
function Oe(t3, n3, r4 = [n3, n3.definitions.raw]) {
...
function Ae(t3) {
  ...
  n3 = t3.lastIndexOf(`)`);
  let r4 = t3.substring(1, n3);
  return [n3, [r4]];
}
function je(t3, n3) {
  let r4 = De.exec(t3), i3 = (r4?.[0] ?? ``) === `.`, a3 = r4?.index ?? t3.length, o3 = t3.substring(0, a3);
...
function F2(t3, n3, r4, i3) {
  ...
  else r4 != null && i3 != null ? a3 = t3.number.int({ min: Number.parseInt(r4), max: Number.parseInt(i3) }) : r4 != null && i3 == null && (a3 = Number.parseInt(r4));
  return a3;
}
function Pe(e4, t3 = ``) {
  let n3 = /(.)\{(\d+),(\d+)\}/, r4 = /(.)\{(\d+)\}/, i3 = /\[(\d+)-(\d+)\]/, a3, o3, s3, c3, l3 = n3.exec(t3);
  ...
  for (l3 = r4.exec(t3); l3 != null; ) c3 = Number.parseInt(l3[2]), t3 = t3.slice(0, l3.index) + l3[1].repeat(c3) + t3.slice(l3.index + l3[0].length), l3 = r4.exec(t3);
...
function I2(e4, t3 = ``, n3 = `#`) {
  let r4 = ``;
  for (let i3 = 0; i3 < t3.length; i3++) t3.charAt(i3) === n3 ? r4 += e4.number.int(9) : t3.charAt(i3) === `!` ? r4 += e4.number.int({ min: 2, max: 9 }) : r4 += t3.charAt(i3);
  return r4;
}
var L2 = class extends x2 {
  ...
  replaceSymbols(e4 = ``) {
    ...
    for (let r4 = 0; r4 < e4.length; r4++) e4.charAt(r4) === `#` ? n3 += this.faker.number.int(9) : e4.charAt(r4) === `?` ? n3 += this.arrayElement(t3) : e4.charAt(r4) === `*` ? n3 += this.faker.datatype.boolean() ? this.arrayElement(t3) : this.faker.number.int(9) : n3 += e4.charAt(r4);
    return n3;
  }
  ...
  fromRegExp(t3) {
    ...
    let r4, i3, a3, o3 = /([.A-Za-z0-9])(?:\{(\d+)(?:,(\d+)|)\}|(\?|\*|\+))(?![^[]*]|[^{]*})/, s3 = o3.exec(t3);
    for (; s3 != null; ) {
    ...
    for (s3 = l3.exec(t3); s3 != null; ) {
      ...
      for (u4 && m3.push(45); g3 != null; ) {
        if (g3[0].includes(`-`)) {
          ...
          if (r4 = t4[0], i3 = t4[1], r4 > i3) throw new e2(`Character range provided is out of order.`);
    ...
    for (s3 = u3.exec(t3); s3 != null; ) {
      ...
      a3 = this.faker.number.int({ min: r4, max: i3 }), t3 = t3.slice(0, s3.index) + s3[1].repeat(a3) + t3.slice(s3.index + s3[0].length), s3 = u3.exec(t3);
    }
    let d3 = /(.)\{(\d+)\}/;
  ...
  uniqueArray(e4, t3) {
    ...
    try {
      if (typeof e4 == `function`) {
        let r4 = 1e3 * t3, i3 = 0;
        for (; n3.size < t3 && i3 < r4; ) n3.add(e4()), i3++;
      }
    } catch {
    }
    return [...n3];
  ...
  weightedArrayElement(t3) {
    ...
    let n3 = t3.reduce((e4, { weight: t4 }) => e4 + t4, 0), r4 = this.faker.number.float({ min: 0, max: n3 }), i3 = 0;
    for (let { weight: e4, value: n4 } of t3) if (i3 += e4, r4 < i3) return n4;
...
var Ie = class extends L2 {
  ...
  fake(e4) {
    ...
    let r4 = Oe(e4.substring(t3 + 2, n3 + 2).replace(`}}`, ``).replace(`{{`, ``), this.faker), i3 = String(r4), a3 = e4.substring(0, t3) + i3 + e4.substring(n3 + 2);
    return this.fake(a3);
  }
};
...
function Le(e4) {
  let { deprecated: t3, since: n3, until: r4, proposed: i3 } = e4, a3 = `[@faker-js/faker]: ${t3} is deprecated`;
...
var Re = class extends S2 {
  ...
  urlLoremFlickr(e4 = {}) {
    ...
    let { width: t3 = this.faker.number.int({ min: 1, max: 3999 }), height: n3 = this.faker.number.int({ min: 1, max: 3999 }), category: r4 } = e4;
    return `https://loremflickr.com/${t3}/${n3}${r4 == null ? `` : `/${r4}`}?lock=${this.faker.number.int()}`;
  }
  urlPicsumPhotos(e4 = {}) {
    let { width: t3 = this.faker.number.int({ min: 1, max: 3999 }), height: n3 = this.faker.number.int({ min: 1, max: 3999 }), grayscale: r4 = this.faker.datatype.boolean(), blur: i3 = this.faker.number.int({ max: 10 }) } = e4, a3 = `https://picsum.photos/seed/${this.faker.string.alphanumeric({ length: { min: 5, max: 10 } })}/${t3}/${n3}`, o3 = typeof i3 == `number` && i3 >= 1 && i3 <= 10;
    return (r4 || o3) && (a3 += `?`, r4 && (a3 += `grayscale`), r4 && o3 && (a3 += `&`), o3 && (a3 += `blur=${i3}`)), a3;
  }
  dataUri(e4 = {}) {
    let { width: t3 = this.faker.number.int({ min: 1, max: 3999 }), height: n3 = this.faker.number.int({ min: 1, max: 3999 }), color: r4 = this.faker.color.rgb(), type: i3 = this.faker.helpers.arrayElement([`svg-uri`, `svg-base64`]) } = e4, a3 = `<svg xmlns="http://www.w3.org/2000/svg" version="1.1" baseProfile="full" width="${t3}" height="${n3}"><rect width="100%" height="100%" fill="${r4}"/><text x="${t3 / 2}" y="${n3 / 2}" font-size="20" alignment-baseline="middle" text-anchor="middle" fill="white">${t3}x${n3}</text></svg>`;
...
var qe = class extends S2 {
  email(e4 = {}) {
    let { firstName: t3, lastName: n3, provider: r4 = this.faker.helpers.arrayElement(this.faker.definitions.internet.free_email), allowSpecialCharacters: i3 = false } = e4, a3 = this.username({ firstName: t3, lastName: n3 });
  ...
  exampleEmail(e4 = {}) {
    let { firstName: t3, lastName: n3, allowSpecialCharacters: r4 = false } = e4, i3 = this.faker.helpers.arrayElement(this.faker.definitions.internet.example_email);
    return this.email({ firstName: t3, lastName: n3, provider: i3, allowSpecialCharacters: r4 });
  }
  username(e4 = {}) {
    let { firstName: t3 = this.faker.person.firstName(), lastName: n3 = this.faker.person.lastName(), lastName: r4 } = e4, i3 = this.faker.helpers.arrayElement([`.`, `_`]), a3 = this.faker.number.int(99), o3 = [() => `${t3}${i3}${n3}${a3}`, () => `${t3}${i3}${n3}`];
    r4 || o3.push(() => `${t3}${a3}`);
  ...
  displayName(e4 = {}) {
    let { firstName: t3 = this.faker.person.firstName(), lastName: n3 = this.faker.person.lastName() } = e4, r4 = this.faker.helpers.arrayElement([`.`, `_`]), i3 = this.faker.number.int(99), a3 = this.faker.helpers.arrayElement([() => `${t3}${i3}`, () => `${t3}${r4}${n3}`, () => `${t3}${r4}${n3}${i3}`])();
  ...
  ipv4(t3 = {}) {
    let { network: n3 = `any`, cidrBlock: r4 = Ke[n3] } = t3;
  ...
  mac(e4 = {}) {
    ...
    let { separator: t3 = `:` } = e4, n3, r4 = ``;
    for ([`:`, `-`, ``].includes(t3) || (t3 = `:`), n3 = 0; n3 < 12; n3++) r4 += this.faker.number.hex(15), n3 % 2 == 1 && n3 !== 11 && (r4 += t3);
    return r4;
  }
  password(e4 = {}) {
    let t3 = /[aeiouAEIOU]$/, n3 = /[bcdfghjklmnpqrstvwxyzBCDFGHJKLMNPQRSTVWXYZ]$/, r4 = (e5, i4, a4, o4) => {
  ...
  jwt(e4 = {}) {
    let { refDate: t3 = this.faker.defaultRefDate() } = e4, n3 = this.faker.date.recent({ refDate: t3 }), { header: r4 = { alg: this.jwtAlgorithm(), typ: `JWT` }, payload: i3 = { iat: Math.round(n3.valueOf() / 1e3), exp: Math.round(this.faker.date.soon({ refDate: n3 }).valueOf() / 1e3), nbf: Math.round(this.faker.date.anytime({ refDate: t3 }).valueOf() / 1e3), iss: this.faker.company.name(), sub: this.faker.string.uuid(), aud: this.faker.string.uuid(), jti: this.faker.string.uuid() } } = e4;
    return `${z2(JSON.stringify(r4))}.${z2(JSON.stringify(i3))}.${this.faker.string.alphanumeric(64)}`;
  }
};
var W2 = class extends x2 {
  latitude(e4 = {}) {
    let { max: t3 = 90, min: n3 = -90, precision: r4 = 4 } = e4;
    return this.faker.number.float({ min: n3, max: t3, fractionDigits: r4 });
  }
  longitude(e4 = {}) {
    let { max: t3 = 180, min: n3 = -180, precision: r4 = 4 } = e4;
    return this.faker.number.float({ max: t3, min: n3, fractionDigits: r4 });
  }
  nearbyGPSCoordinate(e4 = {}) {
    let { origin: t3, radius: n3 = 10, isMetric: r4 = false } = e4;
    if (t3 == null) return [this.latitude(), this.longitude()];
    let i3 = this.faker.number.float({ max: 2 * Math.PI, fractionDigits: 5 }), a3 = r4 ? n3 : n3 * 1.60934, o3 = this.faker.number.float({ max: a3, fractionDigits: 3 }) * 0.995 / (4e4 / 360), s3 = [t3[0] + Math.sin(i3) * o3, t3[1] + Math.cos(i3) * o3];
...
var Je = class extends W2 {
  ...
  zipCode(t3 = {}) {
    ...
    let { format: r4 = this.faker.definitions.location.postcode } = t3;
  ...
  direction(e4 = {}) {
    let { abbreviated: t3 = false } = e4, n3 = this.faker.definitions.location.direction, r4 = t3 ? [...n3.cardinal_abbr, ...n3.ordinal_abbr] : [...n3.cardinal, ...n3.ordinal];
    return this.faker.helpers.arrayElement(r4);
  }
  cardinalDirection(e4 = {}) {
    let { abbreviated: t3 = false } = e4, n3 = this.faker.definitions.location.direction, r4 = t3 ? n3.cardinal_abbr : n3.cardinal;
    return this.faker.helpers.arrayElement(r4);
  }
  ordinalDirection(e4 = {}) {
    let { abbreviated: t3 = false } = e4, n3 = this.faker.definitions.location.direction, r4 = t3 ? n3.ordinal_abbr : n3.ordinal;
    return this.faker.helpers.arrayElement(r4);
  }
  timeZone() {
...
var G2 = { fail: () => {
  ...
  let n3 = Ye(e4, (e5) => e5.length), r4 = Object.keys(n3).map(Number), i3 = Math.min(...r4), a3 = Math.max(...r4), o3 = Math.min(t3.min - i3, a3 - t3.max);
...
function K2(e4) {
  let { wordList: t3, length: n3, strategy: r4 = `fail` } = e4;
  if (n3 != null) {
    let e5 = typeof n3 == `number` ? (e6) => e6.length === n3 : (e6) => e6.length >= n3.min && e6.length <= n3.max, i3 = t3.filter(e5);
    return i3.length > 0 ? i3 : typeof n3 == `number` ? G2[r4](t3, { min: n3, max: n3 }) : G2[r4](t3, n3);
  } else if (r4 === `shortest` || r4 === `longest`) return G2[r4](t3);
  return [...t3];
}
...
function J2(e4, t3 = e4.person.sexType(), n3) {
  ...
  if (t3 === `generic`) return r4 ?? e4.helpers.arrayElement([i3, a3]) ?? [];
...
var Qe = class extends S2 {
  ...
  fullName(e4 = {}) {
    let { sex: t3 = this.faker.helpers.arrayElement([`female`, `male`]), firstName: n3 = this.firstName(t3), lastName: r4 = this.lastName(t3) } = e4, i3 = this.faker.helpers.weightedArrayElement(this.faker.definitions.person.name);
    return this.faker.helpers.mustache(i3, { "person.prefix": () => this.prefix(t3), "person.firstName": () => n3, "person.middleName": () => this.middleName(t3), "person.lastName": () => r4, "person.suffix": () => this.suffix() });
  }
  gender() {
...
var at2 = class extends S2 {
  fileName(e4 = {}) {
    let { extensionCount: t3 = 1 } = e4, n3 = this.faker.word.words().toLowerCase().replaceAll(/\W/g, `_`), r4 = this.faker.helpers.multiple(() => this.fileExt(), { count: t3 }).join(`.`);
  ...
  fileExt(t3) {
    ...
    if (typeof t3 == `string`) {
      let r5 = n3[t3];
      if (r5 == null) throw new e2(`MIME type ${t3} is not supported.`);
  ...
  networkInterface(e4 = {}) {
    let { interfaceType: t3 = this.faker.helpers.arrayElement(rt2), interfaceSchema: n3 = this.faker.helpers.objectKey(Y2) } = e4, r4, i3 = ``;
    switch (n3) {
      case `index`:
...
var lt = class extends x2 {
  int(t3 = {}) {
    ...
    let { min: n3 = 0, max: r4 = 2 ** 53 - 1, multipleOf: i3 = 1, distributor: a3 = b2() } = t3;
  ...
  float(t3 = {}) {
    typeof t3 == `number` && (t3 = { max: t3 });
    let { min: n3 = 0, max: r4 = 1, fractionDigits: i3, multipleOf: a3, multipleOf: o3 = i3 == null ? void 0 : 10 ** -i3, distributor: s3 = b2() } = t3;
  ...
  bigInt(t3 = {}) {
    ...
    let n3 = BigInt(t3.min ?? 0), r4 = BigInt(t3.max ?? n3 + BigInt(999999999999999)), i3 = BigInt(t3.multipleOf ?? 1);
...
function ft(e4, t3) {
  let n3 = t3.valueOf(), r4 = Math.max(n3, 0).toString(16).padStart(12, `0`).slice(-12);
...
var mt2 = class extends x2 {
  ...
  alpha(e4 = {}) {
    ...
    return i3 = i3.filter((e5) => !r4.includes(e5)), this.fromCharacters(i3, t3);
  }
  alphanumeric(e4 = {}) {
    typeof e4 == `number` && (e4 = { length: e4 });
    let t3 = this.faker.helpers.rangeToNumber(e4.length ?? 1);
  ...
  hexadecimal(e4 = {}) {
    let { casing: t3 = `mixed`, prefix: n3 = `0x` } = e4, r4 = this.faker.helpers.rangeToNumber(e4.length ?? 1);
    if (r4 <= 0) return n3;
  ...
  numeric(t3 = {}) {
    ...
    if (n3 <= 0) return ``;
    let { allowLeadingZeros: r4 = true } = t3, { exclude: i3 = [] } = t3;
...
// ../harborclient-sdk/node_modules/.pnpm/@faker-js+faker@10.5.0/node_modules/@faker-js/faker/dist/en-ZD_MKrQh.js
...
// ../harborclient-sdk/node_modules/.pnpm/@faker-js+faker@10.5.0/node_modules/@faker-js/faker/dist/locale/en.js
var r3 = new yt({ locale: [e3, Ct] });

// ../harborclient-sdk/dist/variables/dynamic.js
...
// ../harborclient-sdk/dist/variables/tokens.js
...
function tokenizeVariables(text2) {
  ...
  for (const match of text2.matchAll(pattern)) {
    ...
    if (index > lastIndex) {
      tokens.push({ text: text2.slice(lastIndex, index) });
    }
...
function getVariableTokenAtOffset(text2, offset) {
  ...
  for (const token of tokenizeVariables(text2)) {
    ...
    if (token.key && offset >= start && offset <= end3) {
      return { key: token.key, start, end: end3 };
    }
    position = end3;
  }
  return null;
...
// ../harborclient-sdk/dist/components/forms/classes.js
...
// ../harborclient-sdk/dist/components/forms/Input.js
...
// ../harborclient-sdk/dist/components/forms/Select.js
...
// ../harborclient-sdk/dist/components/VariableInput/index.js
function VariableInput({ value, onChange: onChange2, variables, placeholder, onKeyDown, className = "", wrapperClassName, onEditVariable, id, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledBy }) {
  ...
  }, className: "text-[#32D2E2]", children: token.text }, index) : jsx("span", { children: token.text }, index)) : jsx("span", { className: "text-muted", children: placeholder }) }), jsx(Input, { ref: inputRef, id, variant: "plain", "aria-label": ariaLabel, "aria-labelledby": ariaLabelledBy, "aria-describedby": tooltip ? tooltipId : void 0, className: `relative w-full min-w-0 border-none bg-transparent px-2 py-1.5 text-[14px] text-transparent caret-text focus-visible:shadow-none ${className}`, type: "text", placeholder, value, onChange: (e4) => {
...
// ../harborclient-sdk/dist/components/enhanceControl.js
...
// ../harborclient-sdk/dist/components/FormGroup/index.js
...
// ../harborclient-sdk/dist/components/useDialogFocus.js
...
// ../harborclient-sdk/dist/components/Modal/ModalHeader.js
...
// ../harborclient-sdk/dist/components/Modal/ModalFooter.js
...
// ../harborclient-sdk/dist/components/Modal/index.js
...
// ../harborclient-sdk/dist/components/StatusMessage/index.js
...
// ../harborclient-sdk/dist/storage/validate.js
...
function registerCollectionInIndex(index, collectionId) {
  ...
  return {
    ...index,
    collections: [...index.collections, collectionId].sort((a3, b3) => a3 - b3)
  };
}
...
function activeRuntimeVariables() {
...
function CollectionAwsTab({ context, hc }) {
  ...
  const handleSubmit = useCallback(
    async (event) => {
      ...
      setSaved(false);
      try {
        await saveCollectionAwsConfig(hc, context.collectionId, config2);
        setSaved(true);
...
// ../harborclient-sdk/dist/http/substitute.js
...
function substituteKeyValueRows(rows, runtimeVars) {
  return rows.map((row) => ({
    ...row,
    value: substituteVariables2(row.value, runtimeVars)
  }));
}

// ../harborclient-sdk/dist/http/resolveRequest.js
...
function resolveRequest(context) {
  ...
  const substitute = (text2) => substituteVariables2(text2, variables);
  const resolvedDraft = {
    ...draft,
...
function runtimeVariablesToVariableList(variables) {
...
function resolveCredentialFields(fields, runtimeVars) {
  const resolve = (text2) => {
    if (text2 == null || text2 === "") {
      return text2;
    }
    return substituteVariables2(text2, runtimeVars);
  };
  return {
...
function buildSigningConfigFromProfiles(collection, requestSettings, runtimeVariables = {}) {
...
async function loadConfiguredCollections(hc) {
  ...
  for (const collectionId of index.collections) {
    const stored = await hc.storage.get(collectionStorageKey(collectionId));
    const config2 = parseCollectionAwsConfig(stored);
    if (config2.accessKeyId.trim() && config2.secretAccessKey.trim()) {
      entries.push({ id: collectionId, config: config2 });
    }
  }
...
function subscribeSignPreview(listener2) {
...
// ../harborclient-sdk/dist/clipboard.js
...
function SignPreviewModal({ hc }) {
  ...
  const handleCopyAll = useCallback(async () => {
    ...
    const text2 = Object.entries(preview2.headers).map(([key, value]) => `${key}: ${value}`).join("\n");
    try {
      await copyToClipboard(hc, text2, { toast: "Headers copied" });
    } catch {
    }
  }, [hc, preview2]);
  if (!open || !preview2) {
    ...
    /* @__PURE__ */ jsxs(
      Modal,
      {
        ...
        children: [
          ...
          hasErrors ? /* @__PURE__ */ jsx(StatusMessage, { live: true, className: "mb-4 text-danger", children: /* @__PURE__ */ jsx("ul", { className: "list-disc pl-5", children: preview2.errors?.map((message) => /* @__PURE__ */ jsx("li", { children: message }, message)) }) }) : null,
          !hasErrors && Object.keys(preview2.headers).length > 0 ? /* @__PURE__ */ jsx("dl", { className: "space-y-3 overflow-auto", children: Object.entries(preview2.headers).map(([key, value]) => /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxs(ModalFooter, { spaced: true, children: [
            !hasErrors && Object.keys(preview2.headers).length > 0 ? /* @__PURE__ */ jsx(Button, { type: "button", variant: "secondary", onClick: () => void handleCopyAll(), children: "Copy headers" }) : null,
            /* @__PURE__ */ jsx(Button, { type: "button", variant: "primary", onClick: handleClose, children: "Done" })
          ] })
        ]
      }
    )
...
function RequestAwsTab({ context, hc }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-4 p-4", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid gap-4 sm:grid-cols-2", children: [
      ...
      /* @__PURE__ */ jsx(FormGroup, { label: "Service override", htmlFor: "aws-service-override", children: /* @__PURE__ */ jsx(
        VariableInput,
        {
    ...
    /* @__PURE__ */ jsx(FormGroup, { label: "Session token override", htmlFor: "aws-session-override", children: /* @__PURE__ */ jsx(
      VariableInput,
      {
    ...
    /* @__PURE__ */ jsx(SignPreviewModal, { hc })
  ] });
}
